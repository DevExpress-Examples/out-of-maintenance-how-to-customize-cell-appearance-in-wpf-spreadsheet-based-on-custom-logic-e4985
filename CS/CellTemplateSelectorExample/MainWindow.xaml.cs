...
namespace CellTemplateSelectorExample
{
    ...
    public class CellTemplateSelector : DataTemplateSelector
    {
        public override DataTemplate SelectTemplate(object item, DependencyObject container)
        {
            ...
            return CanApplyCustomTemplate(data.Cell.Position.ToString()) ? GetCellTemplate(data.Cell, (SpreadsheetControl)container) : base.SelectTemplate(item, container);
        }
        ...
        private DataTemplate GetCellTemplate(DevExpress.XtraSpreadsheet.Model.Cell cell, SpreadsheetControl control)
        {
